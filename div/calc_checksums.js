...
async function main() {
    ...
    parser.addArgument('DISTDIR', {help: 'Root distribution directory'});
    parser.addArgument('INCLUDE_PATH', {help: 'Path to files to checksum, relative to DISTDIR'});
    parser.addArgument('OUTFILE', {help: 'File to write'});
