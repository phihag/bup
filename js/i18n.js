  ...
  function translate_nodes(root, s) {
    ...
    uiu.qsEach(
      ...
      function (n) {
        n.setAttribute(
          "placeholder",
          translate(s, n.getAttribute("data-i18n-placeholder"))
        );
      },
      root
    );
    uiu.qsEach(
      ...
      function (n) {
        n.setAttribute(
          "title",
          translate(s, n.getAttribute("data-i18n-title"))
        );
      },
      root
    );
  ...
  function translate(s, str, data, fallback) {
    ...
    if (res === undefined) {
      if (fallback === undefined) {
        /*@DEV*/
        console.error(
          "Untranslated string(" + s.lang + "): " + JSON.stringify(str)
