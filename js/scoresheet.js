...
function sheet_render(s, svg, referee_view) {
	...
	_text('.scoresheet_court_id', (s.setup.court_id ? s.setup.court_id : (referee_view ? '' : s.settings.court_id)));
	_text('.scoresheet_umpire_name', s.metadata.umpire_name ? s.metadata.umpire_name : (s.setup.umpire_name ? s.setup.umpire_name : (referee_view ? '' : s.settings.umpire_name)));
	_text('.scoresheet_service_judge_name', s.metadata.service_judge_name ? s.metadata.service_judge_name : (s.setup.service_judge_name ? s.setup.service_judge_name : (referee_view ? '' : s.settings.service_judge_name)));
