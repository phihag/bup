...
var eventsheet = (function () {
  ...
  var bundesligaLeagueKeys = [
    '1BL-2015', '2BLN-2015', '2BLS-2015',
    '1BL-2016', '2BLN-2016', '2BLS-2016',
    '1BL-2017', '2BLN-2017', '2BLS-2017',
    '1BL-2018', '2BLN-2018', '2BLS-2018',
    '1BL-2019', '2BLN-2019', '2BLS-2019',
    '1BL-2020', '2BLN-2020', '2BLS-2020',
  ];
  ...
  function loaded(key) {
    ...
    _loaded[key] = true;
    _loaded_all_libs = utils.values(_loaded).every(function (x) {
      return x;
    });
    if (_loaded_all_libs) {
